...
expected="apps/brave apps/ghostty core/git core/ssh desktop/fonts desktop/kde development/claude development/codex development/docker development/fish development/github-cli development/node development/python development/uv"
got="$(module::discover | tr '\n' ' ' | sed 's/ *$//')"
assert_eq "all fourteen modules discovered" "$got" "$expected"
