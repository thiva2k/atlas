...
expected="apps/brave apps/ghostty core/git core/ssh desktop/fonts desktop/kde development/claude development/codex development/docker development/github-cli development/python"
got="$(module::discover | tr '\n' ' ' | sed 's/ *$//')"
assert_eq "all eleven modules discovered" "$got" "$expected"
